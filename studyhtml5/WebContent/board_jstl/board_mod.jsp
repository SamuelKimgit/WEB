...
<%--   <h2>vo:<%=vo %></h2> --%>
  ...
  <form action="<%=contPath%>/board/board.do" name="boardFrm" id="boardFrm" class="form-horizontal">
    ...
    <table>
      ...
      <tr>
        <td>등록자</td>
        <td><input value="${vo.regId }" type="text" name="reg_id" id="reg_id" maxlength="50" size="50" readonly></td>
      </tr>
      <tr>
        <td>등록일</td>
        <td><input value="${vo.regDt }" type="text" name="regDt" id="regDt" maxlength="50" size="50" readonly></td>
      </tr>
      <tr>
        <td>수정자</td>
        <td><input value="${vo.modId }" type="text" name="mod_id" id="mod_id" maxlength="50" size="50"></td>
      </tr>
      <tr>
        <td>수정일</td>
        <td><input value="${vo.modDt }" type="text" name="modDt" id="modDt" maxlength="50" size="50" readonly></td>
      </tr>
      <tr>
        <td>조회수</td>
        <td><input value="${vo.readCnt }" type="text" name="readCnt" id="readCnt" maxlength="50" size="50" readonly></td>
      </tr>
      <tr>
        <td colspan="2">내용</td>
      </tr>
